...
<div class="flex flex-col lg:flex-row gap-4 {width} h-full">
  ...
  <div class="flex-1 flex flex-col gap-4 h-full overflow-hidden">
    ...
    <div class="flex-1 overflow-hidden" bind:this={aiAssistantRef}>
      <AIAssistantSection 
        ...
        onQueryExtracted={onQueryExtracted}
  ...
  <div class="flex-1 flex flex-col gap-2 h-full overflow-hidden">
    ...
    <div class="flex-shrink-0 bg-gray-50 dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 p-3">
      <h3 class="text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Query Output</h3>
      <div class="text-xs font-mono text-gray-600 dark:text-gray-400 bg-white dark:bg-gray-900 rounded border p-2 max-h-20 overflow-y-auto">
